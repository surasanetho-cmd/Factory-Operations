...
This constitution defines non-negotiable laws. No feature, migration, or UI may violate these rules without an approved entry in [29_DECISION_LOG.md](29_DECISION_LOG.md).
...
2. Schema changes update [04_DATABASE_STANDARD.md](04_DATABASE_STANDARD.md), [05_DATABASE_DICTIONARY.md](05_DATABASE_DICTIONARY.md), and [06_ER_DIAGRAM.md](06_ER_DIAGRAM.md) in the same change set.
