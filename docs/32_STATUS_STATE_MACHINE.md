...
Permissions: [15_PERMISSION_STANDARD.md](15_PERMISSION_STANDARD.md).  
Business narrative: [27_BUSINESS_FLOW.md](27_BUSINESS_FLOW.md).
...
2. Each transition writes history + optional outbox event ([34](34_DOMAIN_EVENTS.md)).
