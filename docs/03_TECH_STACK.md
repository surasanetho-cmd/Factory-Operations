...
2. Document breaking upgrades in [30_CHANGELOG.md](30_CHANGELOG.md) and [29_DECISION_LOG.md](29_DECISION_LOG.md) when architecture is affected.
...
Details: [21_DEPLOYMENT_STANDARD.md](21_DEPLOYMENT_STANDARD.md).
